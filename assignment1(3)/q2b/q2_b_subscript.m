...
for nu = [.8, 1, 1.5]
    ...
    alphaPdot = @(y) (VP(nu)*V_theta(y(2),y(7))/y(1) - k*(y(7) - y(2)))/VP(nu);
    ...
    xlabel('time(s)')     ; ylabel('\theta(deg)'); hold on;
                ...
                savefig('images/LOSangle')
                print('images/Losangle','-dpng')
    %% PLOT V_THETA
    figure(3);
    plot(TOUT, V_theta_); 
    ...
    xlabel('time(s)')     ; ylabel('V_\theta(m/s)'); hold on;
                ...
                savefig('images/Vtheta')
                print('images/Vtheta','-dpng')
    %% PLOT RANGE RATE
    figure(4);
    plot( TOUT, V_R_ ); 
    ...
    xlabel('time(s)')     ; ylabel('Range Rate(m/s)'); hold on;
                ...
                savefig('images/range_rate')
                print('images/range_rate','-dpng')
    ...
    xlabel('time(s)')     ; ylabel('Acc(m/s^2)'); hold on;
                ...
                savefig('images/Acc_p')
                print('images/Acc_p','-dpng')
